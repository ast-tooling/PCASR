...
class aboutWindow:
    ...
    def __init__(self,parent):
        ...
        self.version_label = ttk.Label(self.about_window,text="PKaser v2.4")
        ...
        self.maintainer_label = ttk.Label(self.about_window,text="Refactored w/ Maintenance & Feature Updates By: Christopher Durham Jr.")
